...
- The local `v0.4.0-preview` release candidate is generated by the build command below; no public Release has been published yet.
...
- `v0.4.0-preview` is an Apple Silicon preview, not a notarized production release.
