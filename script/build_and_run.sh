...
APP_ARCHIVE="$DIST_DIR/Codex.Inner.IDE-v$RELEASE_LABEL-macos-$BUILD_ARCH.zip"
...
SPACE_APP_ARCHIVE="$DIST_DIR/$APP_NAME-v$RELEASE_LABEL-macos-$BUILD_ARCH.zip"
...
rm -f "$SPACE_APP_ARCHIVE" "$SPACE_APP_ARCHIVE.sha256"
